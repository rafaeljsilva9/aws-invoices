...
export class DeleteInvoiceLambda extends Construct {
  private static instance: DeleteInvoiceLambda;
  ...
  private createLambda() {
    this.lambda = new Lambda.Function(this, "Lambda", {
      ...
      code: Lambda.AssetCode.fromAsset("dist/src/functions/delete-invoice"),
  ...
  public static getInstance(): DeleteInvoiceLambda {
    if (!this.instance) {
